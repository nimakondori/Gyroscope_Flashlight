...
//      if (new_rollangle<0) new_rollangle = new_rollangle * -1;
      ...
      if (new_rollangle - rollangle > 6)
        light_change = (int)(abs(new_rollangle) - abs(rollangle));
  
      light_intensity = light_intensity + 0.1 * light_change;
      if (light_intensity > 255 || light_change > 2555) light_intensity = 255;
      else if(light_intensity < 0 || light_change < -2555) light_intensity = 0; 
